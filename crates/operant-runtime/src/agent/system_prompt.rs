...
pub fn build_system_prompt_with_mode(
    ...
    let autonomy_cfg = operant_config::schema::AutonomyConfig {
...
pub fn build_system_prompt_with_mode_and_autonomy(
    ...
    identity_config: Option<&operant_config::schema::IdentityConfig>,
    bootstrap_max_chars: Option<usize>,
    autonomy_config: Option<&operant_config::schema::AutonomyConfig>,
    native_tools: bool,
    skills_prompt_mode: operant_config::schema::SkillsPromptInjectionMode,
    ...
    if prompt.is_empty() {
        "You are Operant, a fast and efficient AI assistant built in Rust. Be helpful, concise, and direct."
            .to_string()
    } else {
        prompt
    }
