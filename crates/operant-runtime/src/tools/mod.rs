...
pub use operant_tools::browser::{BrowserTool, ComputerUseConfig};
pub use operant_tools::browser_delegate::BrowserDelegateTool;
pub use operant_tools::browser_open::BrowserOpenTool;
pub use operant_tools::calculator::CalculatorTool;
pub use operant_tools::canvas::{ALLOWED_CONTENT_TYPES, MAX_CONTENT_SIZE};
pub use operant_tools::canvas::{CanvasStore, CanvasTool};
pub use operant_tools::claude_code::ClaudeCodeTool;
pub use operant_tools::claude_code_runner::ClaudeCodeRunnerTool;
pub use operant_tools::cli_discovery::{DiscoveredCli, discover_cli_tools};
pub use operant_tools::cloud_ops::CloudOpsTool;
pub use operant_tools::cloud_patterns::CloudPatternsTool;
pub use operant_tools::codex_cli::CodexCliTool;
pub use operant_tools::composio::ComposioTool;
pub use operant_tools::content_search::ContentSearchTool;
pub use operant_tools::data_management::DataManagementTool;
pub use operant_tools::discord_search::DiscordSearchTool;
pub use operant_tools::escalate::EscalateToHumanTool;
pub use operant_tools::file_edit::FileEditTool;
pub use operant_tools::file_write::FileWriteTool;
pub use operant_tools::gemini_cli::GeminiCliTool;
pub use operant_tools::git_operations::GitOperationsTool;
pub use operant_tools::glob_search::GlobSearchTool;
pub use operant_tools::google_workspace::GoogleWorkspaceTool;
pub use operant_tools::hardware_board_info::HardwareBoardInfoTool;
pub use operant_tools::hardware_memory_map::HardwareMemoryMapTool;
pub use operant_tools::hardware_memory_read::HardwareMemoryReadTool;
pub use operant_tools::http_request::HttpRequestTool;
pub use operant_tools::image_gen::ImageGenTool;
pub use operant_tools::image_info::ImageInfoTool;
pub use operant_tools::jira_tool::JiraTool;
pub use operant_tools::knowledge_tool::KnowledgeTool;
pub use operant_tools::linkedin::LinkedInTool;
pub use operant_tools::llm_task::LlmTaskTool;
pub use operant_tools::mcp_client::McpRegistry;
pub use operant_tools::mcp_deferred::{
    ActivatedToolSet, DeferredMcpToolSet, build_deferred_tools_section,
};
pub use operant_tools::mcp_tool::McpToolWrapper;
pub use operant_tools::memory_export::MemoryExportTool;
pub use operant_tools::memory_forget::MemoryForgetTool;
pub use operant_tools::memory_purge::MemoryPurgeTool;
pub use operant_tools::memory_recall::MemoryRecallTool;
pub use operant_tools::memory_store::MemoryStoreTool;
pub use operant_tools::microsoft365::Microsoft365Tool;
pub use operant_tools::model_routing_config::ModelRoutingConfigTool;
pub use operant_tools::notion_tool::NotionTool;
pub use operant_tools::opencode_cli::OpenCodeCliTool;
#[cfg(feature = "rag-pdf")]
pub use operant_tools::pdf_read::PdfReadTool;
pub use operant_tools::pipeline::PipelineTool;
pub use operant_tools::poll::PollTool;
pub use operant_tools::project_intel::ProjectIntelTool;
pub use operant_tools::proxy_config::ProxyConfigTool;
pub use operant_tools::pushover::PushoverTool;
pub use operant_tools::reaction::ReactionTool;
pub use operant_tools::report_template_tool::ReportTemplateTool;
pub use operant_tools::screenshot::ScreenshotTool;
pub use operant_tools::sessions::{
    SessionDeleteTool, SessionResetTool, SessionsCurrentTool, SessionsHistoryTool,
    SessionsListTool, SessionsSendTool,
};
pub use operant_tools::swarm::SwarmTool;
pub use operant_tools::text_browser::TextBrowserTool;
pub use operant_tools::tool_search::ToolSearchTool;
pub use operant_tools::weather_tool::WeatherTool;
pub use operant_tools::web_fetch::WebFetchTool;
pub use operant_tools::web_search_tool::WebSearchTool;
...
use operant_config::schema::{Config, DelegateAgentConfig};
...
pub fn all_tools(
    ...
    browser_config: &operant_config::schema::BrowserConfig,
    http_config: &operant_config::schema::HttpRequestConfig,
    web_fetch_config: &operant_config::schema::WebFetchConfig,
    workspace_dir: &std::path::Path,
    agents: &HashMap<String, DelegateAgentConfig>,
    fallback_api_key: Option<&str>,
    root_config: &operant_config::schema::Config,
...
pub fn all_tools_with_runtime(
    ...
    if root_config.channels.discord_history.is_some() {
        match operant_memory::SqliteMemory::new_named(workspace_dir, "discord") {
            Ok(discord_mem) => {
    ...
    // LLM task tool — always registered when a provider is configured
    {
        ...
        let llm_task_runtime_options =
            operant_providers::provider_runtime_options_from_config(root_config);
    ...
    if let Ok(backend) =
        operant_infra::make_session_backend(workspace_dir, &config.channels.session_backend)
    {
        ...
        // operant_tools::sessions but NOT registered by default. They are
    ...
    if root_config.microsoft365.enabled {
        ...
        if !tenant_id.is_empty() && !client_id.is_empty() {
            ...
            let resolved = operant_tools::microsoft365::types::Microsoft365ResolvedConfig {
                tenant_id,
                client_id,
    ...
    if root_config.knowledge.enabled {
        ...
        match operant_memory::knowledge_graph::KnowledgeGraph::new(
            &db_path,
    ...
    if root_config.workspace.enabled {
        ...
        let mut ws_manager = operant_config::workspace::WorkspaceManager::new(workspaces_dir);
    ...
    #[cfg(feature = "plugins-wasm")]
    {
        ...
        if plugin_path.exists() && config.plugins.enabled {
            match operant_plugins::host::PluginHost::new(
                ...
                Ok(host) => {
                    ...
                    for (manifest, wasm_path) in details {
                        tool_arcs.push(Arc::new(operant_plugins::wasm_tool::WasmTool::from_wasm(
...
mod tests {
    use super::*;
    use operant_config::schema::{BrowserConfig, Config, MemoryConfig};
    ...
    fn all_tools_excludes_browser_when_disabled() {
        ...
        let mem: Arc<dyn Memory> =
            Arc::from(operant_memory::create_memory(&mem_cfg, tmp.path(), None).unwrap());
        ...
        let (tools, _, _, _, _, _) = all_tools(
            ...
            &browser,
            &http,
            &operant_config::schema::WebFetchConfig::default(),
            tmp.path(),
            &HashMap::new(),
            None,
            &cfg,
