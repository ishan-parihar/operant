...
use operant_config::schema::OtpConfig;
...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(operant_dir);
...
pub fn secret_file_path(operant_dir: &Path) -> PathBuf {
    operant_dir.join(OTP_SECRET_FILE)
}
