...
const SNAPSHOT_HEADER: &str = "# 🧠 Operant Memory Snapshot\n\n\
    > Auto-generated by Operant. Do not edit manually unless you know what you're doing.\n\
...
pub fn export_snapshot(workspace_dir: &Path) -> Result<usize> {
    ...
    // write! to a String is infallible (fmt::Write on String never fails).
    use std::fmt::Write as _;
    let _ = writeln!(output, "**Last exported:** {now}");
    let _ = writeln!(output, "**Total core memories:** {}\n---\n", rows.len());
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 Operant Memory Snapshot

> Auto-generated by Operant.
...
I am Operant, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 Operant Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
