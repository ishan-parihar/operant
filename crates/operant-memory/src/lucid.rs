...
impl LucidMemory {
    ...
    pub fn new(workspace_dir: &Path, local: SqliteMemory) -> Self {
        ...
        let token_budget = std::env::var("OPERANT_LUCID_BUDGET")
            .ok()
