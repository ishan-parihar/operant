...
//!   OAuth server metadata (3 JSON files per server in `~/.hermes/mcp-tokens/`).
...
const DEFAULT_CLIENT_NAME: &str = "Hermes RS Agent";
...
/// Matches the Python `get_hermes_home()`.
