...
//! over time. Ported from concept in hermes-agent/rl_cli.py.
//!
//! ## Architecture
//!
...
//! a configurable path (default: `~/.hermes/rl/`).
...
pub fn check_tinker_atropos(hermes_home: &Path) -> (bool, String) {
    let tinker_path = hermes_home.join("tinker-atropos");
