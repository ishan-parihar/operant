...
#[async_trait]
impl HermesTool for FileStateTool {
    fn name(&self) -> &str {
        "file_state"
    }
...
mod tests {
    ...
    async fn test_file_state_watch_and_diff() {
        let tmp_path = "/tmp/hermes_test_file_state.txt";
    ...
    fn test_compute_hash_known_content() {
        ...
        let path = dir.join("hermes_test_hash_known.txt");
    ...
    fn test_compute_hash_empty_file() {
        let dir = std::env::temp_dir();
        let path = dir.join("hermes_test_hash_empty.txt");
    ...
    fn test_compute_hash_different_content_different_hash() {
        let dir = std::env::temp_dir();
        let path_a = dir.join("hermes_test_hash_a.txt");
        let path_b = dir.join("hermes_test_hash_b.txt");
    ...
    fn test_get_file_metadata_basic() {
        let dir = std::env::temp_dir();
        let path = dir.join("hermes_test_meta_basic.txt");
    ...
    async fn test_file_state_diff_without_watch() {
        let dir = std::env::temp_dir();
        let path = dir.join("hermes_test_diff_nowatch.txt");
