...
pub enum TrustLevel {
    /// Ships with Hermes — never scanned, always trusted.
    Builtin,
...
lazy_static! {
    static ref THREAT_PATTERNS: Vec<ThreatPattern> = {
        ...
        vec![
            ...
            tp!(r"\$HOME/\.hermes/\.env|\~/\.hermes/\.env",
                "hermes_env_access", Severity::Critical, "exfiltration",
            ...
            tp!(r"\.hermes/config\.yaml|\.hermes/SOUL\.md",
                "hermes_config_mod", Severity::Critical, "persistence",
