...
// hasn't yet tried the Operant Code Desktop app.  Mirrors the behavior of
// src/components/DesktopUpsell/DesktopUpsellStartup.tsx:
//
//   - Shown at most 3 times per user (seen_count guard).
//   - Three choices: "Open in Operant Code Desktop" (Try), "Not now", "Don't ask again".
...
/// Returns true when Operant Desktop is a supported platform option.
...
impl DesktopUpsellSelection {
    fn label(self) -> &'static str {
        match self {
            Self::Try => "Open in Operant Code Desktop",
            Self::NotNow => "Not now",
...
pub fn render_desktop_upsell_startup(
    ...
    let mut lines: Vec<Line> = vec![
        ...
        Line::from(vec![Span::styled(
            "Same Operant features with visual diffs, live app",
...
mod tests {
    ...
    fn desktop_upsell_render_smoke() {
        ...
        assert!(rendered.contains("Operant Code Desktop") || rendered.contains("visual diffs"));
    }
