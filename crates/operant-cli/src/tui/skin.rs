...
fn default_welcome() -> String {
    "Welcome to Operant Agent! Type your message or /help for commands.".into()
}
...
impl Default for SkinConfig {
    fn default() -> Self {
        Self {
            name: "default".into(),
            description: "Classic Operant \u{2014} gold and kawaii".into(),
...
fn builtin_mono() -> SkinConfig {
    SkinConfig {
        ...
        branding: BrandingConfig {
            ...
            response_label: " \u{2695} Operant ".into(),
...
fn user_skins_dir() -> Option<PathBuf> {
    dirs::home_dir().map(|h| h.join(".operant").join("skins"))
}
...
mod tests {
    ...
    fn default_skin_has_correct_name() {
        ...
        assert_eq!(skin.branding.agent_name, "Operant Agent");
    }
    ...
    fn user_skin_merge_fills_missing_fields() {
        ...
        assert_eq!(merged.branding.agent_name, "Operant Agent");
    }
}
