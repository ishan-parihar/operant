//! Migration from OpenClaw (~/.openclaw) to Operant format.
//! Ported from operant-agent/operant_cli/setup.py:_offer_openclaw_migration
...
/// Perform actual migration — copy OpenClaw skills to Operant skills dir.
