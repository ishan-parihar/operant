//! Plugin manifest — `~/.operant/tools/<name>/tool.toml` schema.
//!
...
/// Execution configuration — how Operant spawns the tool.
#[derive(Debug, Deserialize)]
...
///
/// When present, Operant will prefer the named transport kind
