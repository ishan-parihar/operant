...
//! sketch code and calls this tool. Operant compiles and uploads it — no
...
impl Tool for ArduinoUploadTool {
    ...
    async fn execute(&self, args: Value) -> anyhow::Result<ToolResult> {
        ...
        let sketch_name = "operant_sketch";
        let temp_dir = std::env::temp_dir().join(format!("operant_{}", uuid::Uuid::new_v4()));
