...
pub struct WhatsAppWebChannel {
    ...
    mode: operant_config::schema::WhatsAppWebMode,
    /// DM policy when mode = personal
    dm_policy: operant_config::schema::WhatsAppChatPolicy,
    /// Group policy when mode = personal
    group_policy: operant_config::schema::WhatsAppChatPolicy,
...
impl WhatsAppWebChannel {
    ...
    async fn try_transcribe_voice_note(
        ...
        transcription_config: Option<&operant_config::schema::TranscriptionConfig>,
                    ...
                    async move {
                        match event {
                            Event::Message(msg, info) => {
                                ...
                                if wa_mode == operant_config::schema::WhatsAppWebMode::Personal {
                                        ...
                                        )
                                    {
                                        ...
                                        match wa_group_policy {
                                            operant_config::schema::WhatsAppChatPolicy::Ignore => {
                                                tracing::debug!(
                                                    "WhatsApp Web: ignoring group message (group_policy=ignore)"
                                                );
                                                return;
                                            }
                                            operant_config::schema::WhatsAppChatPolicy::All => {
                                                // allow unconditionally
                                            }
                                            operant_config::schema::WhatsAppChatPolicy::Allowlist => {
...
impl WhatsAppWebChannel {
    pub fn new(
        ...
        _mention_only: bool,
        _mode: operant_config::schema::WhatsAppWebMode,
        _dm_policy: operant_config::schema::WhatsAppChatPolicy,
        _group_policy: operant_config::schema::WhatsAppChatPolicy,
        _self_chat_mode: bool,
    ) -> Self {
        Self { _private: () }
    }

    pub fn with_transcription(self, _config: operant_config::schema::TranscriptionConfig) -> Self {
        self
    }

    pub fn with_tts(self, _config: operant_config::schema::TtsConfig) -> Self {
        self
    }
}
...
mod tests {
    ...
    fn make_channel() -> WhatsAppWebChannel {
        WhatsAppWebChannel::new(
            ...
            vec!["+1234567890".into()],
            false,
            operant_config::schema::WhatsAppWebMode::default(),
            operant_config::schema::WhatsAppChatPolicy::default(),
            operant_config::schema::WhatsAppChatPolicy::default(),
            false,
        )
    }
