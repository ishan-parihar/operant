...
use operant_config::schema::{LineDmPolicy, LineGroupPolicy};
...
impl LineChannel {
    ...
    pub fn new(
        ...
        Self {
            ...
            client: operant_config::schema::build_channel_proxy_client("channel.line", None),
    ...
    /// Construct a `LineChannel` directly from a [`operant_config::schema::LineConfig`].
    ///
    ...
    pub fn from_config(config: &operant_config::schema::LineConfig) -> Self {
        Self::new(
    ...
    pub fn with_proxy_url(mut self, proxy_url: Option<String>) -> Self {
        self.client = operant_config::schema::build_channel_proxy_client(
            "channel.line",
            proxy_url.as_deref(),
        );
        self
...
mod tests {
    ...
    async fn with_transcription_disabled_config_is_noop() {
        ...
        .with_transcription(operant_config::schema::TranscriptionConfig {
            enabled: false,
            ..Default::default()
        });
    ...
    async fn webhook_audio_transcribed_and_forwarded() {
        ...
        let transcription_config = operant_config::schema::TranscriptionConfig {
            enabled: true,
