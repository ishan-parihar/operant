...
pub struct LarkChannel {
    ...
    receive_mode: operant_config::schema::LarkReceiveMode,
...
impl LarkChannel {
    ...
    fn new_with_platform(
        ...
        Self {
            ...
            mention_only,
            platform,
            receive_mode: operant_config::schema::LarkReceiveMode::default(),
    ...
    pub fn from_config(config: &operant_config::schema::LarkConfig) -> Self {
    ...
    pub fn from_lark_config(config: &operant_config::schema::LarkConfig) -> Self {
        let mut ch = Self::new_with_platform(
            config.app_id.clone(),
            config.app_secret.clone(),
            config.verification_token.clone().unwrap_or_default(),
    ...
    pub fn from_feishu_config(config: &operant_config::schema::FeishuConfig) -> Self {
        let mut ch = Self::new_with_platform(
            config.app_id.clone(),
            config.app_secret.clone(),
            config.verification_token.clone().unwrap_or_default(),
...
impl Channel for LarkChannel {
    ...
    async fn listen(&self, tx: tokio::sync::mpsc::Sender<ChannelMessage>) -> anyhow::Result<()> {
        use operant_config::schema::LarkReceiveMode;
...
mod tests {
    ...
    fn lark_config_serde() {
        use operant_config::schema::{LarkConfig, LarkReceiveMode};
        let lc = LarkConfig {
            enabled: true,
    ...
    fn lark_from_feishu_config_sets_feishu_platform() {
        use operant_config::schema::{FeishuConfig, LarkReceiveMode};
    ...
    fn lark_reaction_url_matches_region() {
        ...
        let feishu_cfg = operant_config::schema::FeishuConfig {
            enabled: true,
            app_id: "cli_app123".into(),
            app_secret: "secret456".into(),
            encrypt_key: None,
            ...
            allowed_users: vec!["*".into()],
            mention_only: false,
            receive_mode: operant_config::schema::LarkReceiveMode::Webhook,
            port: Some(9898),
            proxy_url: None,
        };
    ...
    async fn lark_audio_file_key_missing_returns_none() {
        ...
        let tc = operant_config::schema::TranscriptionConfig {
            ...
            local_whisper: Some(operant_config::schema::LocalWhisperConfig {
