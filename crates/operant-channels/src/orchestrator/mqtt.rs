...
use operant_config::schema::MqttConfig;
use operant_runtime::sop::audit::SopAuditLogger;
use operant_runtime::sop::dispatch::{dispatch_sop_event, process_headless_results};
use operant_runtime::sop::engine::{SopEngine, now_iso8601};
use operant_runtime::sop::types::{SopEvent, SopTriggerSource};
...
pub async fn run_mqtt_sop_listener(
    ...
    operant_runtime::health::mark_component_ok("mqtt");
    ...
    loop {
        match eventloop.poll().await {
            ...
            Err(e) => {
                operant_runtime::health::mark_component_error("mqtt", e.to_string());
