...
use operant_runtime::observability::{self, Observer, runtime_trace};
...
const SYSTEMD_STATUS_ARGS: [&str; 3] = ["--user", "is-active", "operant.service"];
const SYSTEMD_RESTART_ARGS: [&str; 3] = ["--user", "restart", "operant.service"];
const OPENRC_STATUS_ARGS: [&str; 2] = ["operant", "status"];
const OPENRC_RESTART_ARGS: [&str; 2] = ["operant", "restart"];
...
struct ChannelCostTrackingState {
    tracker: Arc<operant_runtime::cost::CostTracker>,
    prices: Arc<HashMap<String, operant_config::schema::ModelPricing>>,
}
...
struct ChannelRuntimeContext {
    ...
    prompt_config: Arc<operant_config::schema::Config>,
    ...
    api_key: Option<String>,
    api_url: Option<String>,
    reliability: Arc<operant_config::schema::ReliabilityConfig>,
    ...
    media_pipeline: operant_config::schema::MediaPipelineConfig,
    transcription_config: operant_config::schema::TranscriptionConfig,
    hooks: Option<Arc<operant_runtime::hooks::HookRunner>>,
    non_cli_excluded_tools: Arc<Vec<String>>,
    autonomy_level: AutonomyLevel,
    tool_call_dedup_exempt: Arc<Vec<String>>,
    model_routes: Arc<Vec<operant_config::schema::ModelRouteConfig>>,
    query_classification: operant_config::schema::QueryClassificationConfig,
    ack_reactions: bool,
    show_tool_calls: bool,
    session_store: Option<Arc<dyn operant_infra::session_backend::SessionBackend>>,
    ...
    debouncer: Arc<operant_infra::debounce::MessageDebouncer>,
    ...
    receipt_generator: Option<operant_runtime::agent::tool_receipts::ReceiptGenerator>,
...
fn conversation_memory_key(msg: &operant_api::channel::ChannelMessage) -> String {
...
fn followup_thread_id(msg: &operant_api::channel::ChannelMessage) -> Option<String> {
...
fn interruption_scope_key(msg: &operant_api::channel::ChannelMessage) -> String {
...
This is an example JSON object for profile settings."#;
    ...
    async fn supervised_listener_refreshes_health_while_running() {
        ...
        let first_last_ok = operant_runtime::health::snapshot_json()["components"][&component_name]
            ["last_ok"]
            .as_str()
            .unwrap_or("")
            .to_string();
        ...
        let second_last_ok = operant_runtime::health::snapshot_json()["components"]
