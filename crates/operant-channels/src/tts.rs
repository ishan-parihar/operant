...
use operant_config::schema::TtsConfig;
...
impl OpenAiTtsProvider {
    ...
    pub fn new(config: &operant_config::schema::OpenAiTtsConfig) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
            .map(str::trim)
...
impl ElevenLabsTtsProvider {
    ...
    pub fn new(config: &operant_config::schema::ElevenLabsTtsConfig) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
            .map(str::trim)
...
impl GoogleTtsProvider {
    ...
    pub fn new(config: &operant_config::schema::GoogleTtsConfig) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
            .map(str::trim)
...
impl EdgeTtsProvider {
    ...
    pub fn new(config: &operant_config::schema::EdgeTtsConfig) -> Result<Self> {
...
impl TtsProvider for EdgeTtsProvider {
    ...
    async fn synthesize(&self, text: &str, voice: &str) -> Result<Vec<u8>> {
        ...
        let output_file = temp_dir.join(format!("operant_tts_{}.mp3", uuid::Uuid::new_v4()));
...
mod tests {
    ...
    fn tts_manager_with_edge_provider() {
        ...
        config.edge = Some(operant_config::schema::EdgeTtsConfig {
    ...
    fn tts_manager_with_piper_provider() {
        ...
        config.piper = Some(operant_config::schema::PiperTtsConfig {
