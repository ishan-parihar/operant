...
use operant_config::schema::{MatrixConfig, StreamMode, TranscriptionConfig};
...
mod client {
    ...
    use super::session;
    use operant_config::schema::MatrixConfig;
...
mod inbound {
    ...
    use operant_config::schema::{MatrixConfig, TranscriptionConfig};
...
mod outbound {
    ...
    use operant_api::{channel::SendMessage, media::MediaAttachment};
