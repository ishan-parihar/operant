...
use operant_api::media::MediaAttachment;
...
pub struct DiscordChannel {
    ...
    stream_mode: operant_config::schema::StreamMode,
...
fn chunks_for_send(
    ...
    let mut chunks = match stream_mode {
        operant_config::schema::StreamMode::MultiMessage => {
...
impl Channel for DiscordChannel {
    ...
    async fn send(&self, message: &SendMessage) -> anyhow::Result<()> {
        ...
        let inter_chunk_delay_ms =
            if self.stream_mode == operant_config::schema::StreamMode::MultiMessage {
    ...
    async fn listen(&self, tx: tokio::sync::mpsc::Sender<ChannelMessage>) -> anyhow::Result<()> {
        ...
        let watchdog = if self.stall_timeout_secs > 0 {
            Some(operant_infra::stall_watchdog::StallWatchdog::new(
    ...
    fn supports_draft_updates(&self) -> bool {
        self.stream_mode != operant_config::schema::StreamMode::Off
    }

    fn supports_multi_message_streaming(&self) -> bool {
        self.stream_mode == operant_config::schema::StreamMode::MultiMessage
    }
