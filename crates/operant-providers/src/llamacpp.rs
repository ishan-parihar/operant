...
impl LlamaCppProvider {
    ...
    fn http_client(&self) -> Client {
        ...
        if self.extra_headers.is_empty() {
            return operant_config::schema::build_runtime_proxy_client_with_timeouts(
                "provider.llamacpp",
                timeout,
                10,
            );
        ...
        let builder =
            operant_config::schema::apply_runtime_proxy_to_builder(builder, "provider.llamacpp");
    ...
    fn sanitize_tool_payload_for_model(
        ...
        tools
            ...
            .map(|mut tool| {
                ...
                let cleaned_parameters = operant_api::schema::SchemaCleanr::clean(
                    raw_parameters,
                    operant_api::schema::CleaningStrategy::Conservative,
                );
...
mod tool_schema_tests {
    ...
    fn ref_tool_spec() -> operant_api::tool::ToolSpec {
        operant_api::tool::ToolSpec {
    ...
    fn non_gemma_models_keep_openai_cleaned_tool_schema() {
        ...
        let expected =
            operant_api::schema::SchemaCleanr::clean_for_openai(specs[0].parameters.clone());
