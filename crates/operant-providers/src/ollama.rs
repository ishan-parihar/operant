...
impl OllamaProvider {
    ...
    fn http_client(&self) -> Client {
        operant_config::schema::build_runtime_proxy_client_with_timeouts("provider.ollama", 300, 10)
    }
...
impl Provider for OllamaProvider {
    ...
    fn supports_native_tools(&self) -> bool {
        ...
        // See: https://github.com/zeroclaw-labs/operant/issues/3999
        false
    }
    ...
    async fn chat(
            ...
            && !specs.is_empty()
        {
            let tools: Vec<serde_json::Value> = specs
                ...
                .map(|s| {
                    let params =
                        operant_api::schema::SchemaCleanr::clean_for_openai(s.parameters.clone());
                    serde_json::json!({
                        "type": "function",
                        "function": {
                            "name": s.name,
