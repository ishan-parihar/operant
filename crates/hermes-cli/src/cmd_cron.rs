...
//!
//! Provides `hermes cron list`, `hermes cron create`, `hermes cron get`,
//! `hermes cron update`, `hermes cron delete`, `hermes cron pause`,
//! `hermes cron resume`, `hermes cron run`, `hermes cron status`,
//! and `hermes cron tick`.
