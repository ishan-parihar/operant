//! CLI configuration layer for Hermes-RS.
//!
...
/// Current config schema version — bump when adding migratable changes.
pub const CONFIG_VERSION: &str = "1.0.0";

/// Known migration steps: (from_version, to_version, description).
pub const MIGRATION_STEPS: &[(&str, &str, &str)] = &[
    ("0.1.0", "0.2.0", "Renamed openai -> api"),
    ("0.2.0", "0.3.0", "Added gateways section"),
    ("0.3.0", "0.4.0", "Renamed bots -> integrations"),
    ("0.4.0", "1.0.0", "Skills moved under hermes.skills_dir"),
];
...
impl Default for ModelCatalogConfig {
    fn default() -> Self {
        Self {
            enabled: Some(true),
            url: Some(
                "https://hermes-agent.nousresearch.com/docs/api/model-catalog.json".to_string(),
            ),
            ttl_hours: Some(24),
...
/// Information about a known environment variable.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Returns the full map of known environment variables with metadata.
pub fn known_env_vars() -> Vec<EnvVarInfo> {
    vec![
        ...
        EnvVarInfo {
            ...
            description: "OpenRouter API key (for vision, web scraping, MoA)",
            default: None,
            section: EnvSection::Provider,
            advanced: true,
        },
        ...
        EnvVarInfo {
            name: "GEMINI_API_KEY",
            description: "Google AI Studio API key (alias)",
            default: None,
            section: EnvSection::Provider,
            advanced: true,
        },
        ...
        EnvVarInfo {
            name: "AWS_PROFILE",
            description: "AWS named profile for Bedrock auth",
            default: None,
            section: EnvSection::Provider,
            advanced: true,
        },
        ...
        EnvVarInfo {
            ...
            description: "Azure Foundry base URL",
            default: None,
            section: EnvSection::Provider,
            advanced: true,
        },
        EnvVarInfo {
            name: "HF_TOKEN",
            description: "Hugging Face token for Inference Providers",
            default: None,
            section: EnvSection::Provider,
            advanced: false,
        },
        ...
        EnvVarInfo {
            ...
            description: "Ollama Cloud base URL override",
            default: None,
            section: EnvSection::Provider,
            advanced: true,
        },
        ...
        EnvVarInfo {
            ...
            description: "Alibaba DashScope API key (Qwen)",
            default: None,
            section: EnvSection::Provider,
            advanced: false,
        },
        ...
        EnvVarInfo {
            name: "ZAI_API_KEY",
            description: "Z.AI API key (alias)",
            default: None,
            section: EnvSection::Provider,
            advanced: true,
        },
        ...
        EnvVarInfo {
            name: "LM_API_KEY",
            description: "LM Studio bearer token",
            default: None,
            section: EnvSection::Provider,
            advanced: true,
        },
        ...
        EnvVarInfo {
            ...
            description: "StepFun base URL override",
            default: None,
            section: EnvSection::Provider,
            advanced: true,
        },
        ...
        EnvVarInfo {
            name: "ARCEE_BASE_URL",
            description: "Arcee base URL override",
            default: None,
            section: EnvSection::Provider,
            advanced: true,
        },
        ...
        EnvVarInfo {
            name: "HERMES_QWEN_BASE_URL",
            description: "Qwen Portal base URL override",
            default: None,
            section: EnvSection::Provider,
            advanced: true,
        },
        ...
        EnvVarInfo {
            name: "TAVILY_API_KEY",
            description: "Tavily API key for web search/extract/crawl",
            default: None,
            section: EnvSection::Tool,
            advanced: false,
        },
        EnvVarInfo {
            name: "EXA_API_KEY",
            description: "Exa API key for AI-native web search",
            default: None,
            section: EnvSection::Tool,
            advanced: false,
        },
        EnvVarInfo {
            ...
            description: "Parallel API key for web search/extract",
            default: None,
            section: EnvSection::Tool,
            advanced: true,
        },
        EnvVarInfo {
            ...
            description: "Firecrawl API key for web search/scraping",
            default: None,
            section: EnvSection::Tool,
            advanced: false,
        },
        ...
        EnvVarInfo {
            ...
            description: "Browserbase API key for cloud browser",
            default: None,
            section: EnvSection::Tool,
            advanced: false,
        },
        ...
        EnvVarInfo {
            ...
            description: "Browser Use API key for cloud browser",
            default: None,
            section: EnvSection::Tool,
            advanced: true,
        },
        EnvVarInfo {
            name: "CAMOFOX_URL",
            description: "Camofox browser server URL for anti-detection browsing",
            default: None,
            section: EnvSection::Tool,
            advanced: true,
        },
        ...
        EnvVarInfo {
            name: "GITHUB_TOKEN",
            description: "GitHub token for Skills Hub",
            default: None,
            section: EnvSection::Tool,
            advanced: false,
        },
        ...
        EnvVarInfo {
            ...
            description: "Mistral API key for Voxtral TTS/STT",
            default: None,
            section: EnvSection::Tool,
            advanced: false,
        },
        // ── Messaging platform env vars ──
        EnvVarInfo {
            name: "TELEGRAM_BOT_TOKEN",
            description: "Telegram bot token from @BotFather",
            default: None,
            section: EnvSection::Messaging,
            advanced: false,
        },
        EnvVarInfo {
        ...
        EnvVarInfo {
            name: "TELEGRAM_PROXY",
            description: "Proxy URL for Telegram connections",
            default: None,
            section: EnvSection::Messaging,
            advanced: true,
        },
        ...
        EnvVarInfo {
            ...
            description: "Matrix password (fallback if no access token)",
            default: None,
            section: EnvSection::Messaging,
            advanced: true,
        },
        EnvVarInfo {
            ...
            description: "Comma-separated Matrix user IDs allowed to use the bot",
            default: None,
            section: EnvSection::Messaging,
            advanced: false,
        },
        EnvVarInfo {
            ...
            description: "Stable Matrix device ID for E2EE persistence",
            default: None,
            section: EnvSection::Messaging,
            advanced: true,
        },
        EnvVarInfo {
            ...
            description: "Matrix recovery key for cross-signing",
            default: None,
            section: EnvSection::Messaging,
            advanced: true,
        },
        ...
        // ── General settings env vars ──
        EnvVarInfo {
            name: "HERMES_HOME",
            description: "Hermes data directory override",
            default: Some("~/.hermes"),
            section: EnvSection::Setting,
            advanced: false,
        },
        EnvVarInfo {
            name: "HERMES_CONFIG",
            description: "Path to config file override",
            default: None,
            section: EnvSection::Setting,
            advanced: false,
        },
        ...
        EnvVarInfo {
            name: "HERMES_MANAGED",
            description: "Managed mode (NixOS/Homebrew)",
            default: None,
            section: EnvSection::Setting,
            advanced: true,
        },
        ...
        EnvVarInfo {
            ...
            description: "Container mode flag",
            default: None,
            section: EnvSection::Setting,
            advanced: true,
        },
        EnvVarInfo {
            ...
            description: "Skip chmod on config files",
            default: None,
            section: EnvSection::Setting,
            advanced: true,
        },
...
impl CliConfig {
    ...
    pub fn load() -> ConfigResult<Self> {
        ...
        config.apply_hermes_env_overrides();
    ...
    fn apply_hermes_env_overrides(&mut self) {
        ...
        if let Ok(val) = std::env::var("HERMES_SKILLS_DIR") {
            if !val.is_empty() {
                self.hermes.skills_dir = Some(PathBuf::from(val));
            }
        }
...
/// Migrate a raw YAML config value from one version to another.
///
/// Returns the migrated config and a list of migration steps applied.
pub fn migrate_config(
    ...
    for &(step_from, step_to, description) in MIGRATION_STEPS {
        if current == step_from {
            apply_migration_step(config, step_from, step_to)?;
            applied.push(format!("{} -> {}: {}", step_from, step_to, description));
            current = step_to.to_string();
    ...
    if let Some(ver_field) = config.as_mapping_mut() {
        ver_field.insert(
    ...
    if current != to_version {
        return Err(ConfigError::Migration(format!(
            "Unknown migration path: {from_version} -> {to_version}"
        )));
    }
...
fn apply_migration_step(config: &mut Value, from: &str, to: &str) -> ConfigResult<()> {
    match (from, to) {
        ("0.1.0", "0.2.0") => {
            // Rename "openai" to "api" section
            if let Some(map) = config.as_mapping_mut() {
                if let Some(openai_val) = map.remove(&Value::String("openai".to_string())) {
                    map.insert(Value::String("api".to_string()), openai_val);
                }
            }
            Ok(())
        }
        ("0.2.0", "0.3.0") => {
            // Add empty gateways section if missing
            if let Some(map) = config.as_mapping_mut() {
                if !map.contains_key(&Value::String("gateways".to_string())) {
                    map.insert(
        ...
        ("0.3.0", "0.4.0") => {
            // Rename "bots" to "integrations"
            if let Some(map) = config.as_mapping_mut() {
                if let Some(bots_val) = map.remove(&Value::String("bots".to_string())) {
                    map.insert(Value::String("integrations".to_string()), bots_val);
                }
            }
            Ok(())
        }
        ("0.4.0", "1.0.0") => {
            // Move skills config under hermes.skills_dir
            if let Some(map) = config.as_mapping_mut() {
                if let Some(skills_val) = map.remove(&Value::String("skills".to_string())) {
                    if let Some(skills_map) = skills_val.as_mapping() {
                        if let Some(dir_val) =
                            skills_map.get(&Value::String("root_dir".to_string()))
                        {
                            let hermes_key = Value::String("hermes".to_string());
                            let hermes_entry = map
                                .entry(hermes_key)
                                .or_insert_with(|| Value::Mapping(serde_yaml::Mapping::new()));
                            if let Some(hermes_map) = hermes_entry.as_mapping_mut() {
                                hermes_map.insert(
                                    Value::String("skills_dir".to_string()),
                                    dir_val.clone(),
                                );
                            }
                        }
        ...
        _ => Err(ConfigError::Migration(format!(
...
impl CliConfig {
    ...
    pub fn validate(&self) -> Vec<ConfigWarning> {
        ...
        if self.api.default_model.as_deref().unwrap_or("").is_empty() && self.api.models.is_empty()
        {
            warnings.push(ConfigWarning {
                severity: WarningSeverity::Warning,
                message: "No models configured. Set api.default_model or add models.".to_string(),
                field: Some("api.default_model".to_string()),
            });
        }

        // Check API provider config
        if self.api.base_url.as_deref().unwrap_or("").is_empty() && self.api.provider.is_none() {
            warnings.push(ConfigWarning {
                severity: WarningSeverity::Warning,
                message: "No API provider configured. Set api.base_url or api.provider."
                    .to_string(),
        ...
        if let Some(ref level) = self.logging.level {
            let valid_levels = ["DEBUG", "INFO", "WARN", "WARNING", "ERROR", "TRACE"];
        ...
        if let Some(ref backend) = self.terminal.backend {
            let valid_backends = ["local", "docker", "ssh", "modal", "daytona", "singularity"];
            if !valid_backends.iter().any(|b| b == backend) {
                warnings.push(ConfigWarning {
                    severity: WarningSeverity::Info,
                    message: format!("Unknown terminal backend '{}'.", backend),
                    field: Some("terminal.backend".to_string()),
                });
            }
        }

        // Check gateway configs for mismatched enabled/token
        if self.gateways.telegram.enabled.unwrap_or(false) && self.gateways.telegram.token.is_none()
        {
            warnings.push(ConfigWarning {
                severity: WarningSeverity::Warning,
                message: "Telegram gateway enabled but no token configured.".to_string(),
                field: Some("gateways.telegram.token".to_string()),
            });
        }

        if self.gateways.discord.enabled.unwrap_or(false) && self.gateways.discord.token.is_none() {
            warnings.push(ConfigWarning {
                severity: WarningSeverity::Warning,
                message: "Discord gateway enabled but no token configured.".to_string(),
                field: Some("gateways.discord.token".to_string()),
            });
        }
        ...
        if let Some(threshold) = self.compression.threshold {
            if !(0.0..=1.0).contains(&threshold) {
                warnings.push(ConfigWarning {
                    severity: WarningSeverity::Warning,
                    message: "compression.threshold should be between 0.0 and 1.0.".to_string(),
                    field: Some("compression.threshold".to_string()),
                });
            }
        }

        if let Some(target) = self.compression.target_ratio {
            if !(0.0..=1.0).contains(&target) {
                warnings.push(ConfigWarning {
                    severity: WarningSeverity::Warning,
                    message: "compression.target_ratio should be between 0.0 and 1.0.".to_string(),
                    field: Some("compression.target_ratio".to_string()),
                });
            }
        }
...
/// Compute a diff between two CliConfigs, returning a list of changes.
pub fn config_diff(old: &CliConfig, new: &CliConfig) -> Vec<ConfigChange> {
    let mut changes = Vec::new();

    // Use serialized YAML values for comparison
    let old_val = serde_yaml::to_value(old).unwrap_or(Value::Null);
    let new_val = serde_yaml::to_value(new).unwrap_or(Value::Null);
...
/// Recursively diff two YAML values, recording changes.
fn diff_values(old: &Value, new: &Value, path: String, changes: &mut Vec<ConfigChange>) {
    match (old, new) {
        (Value::Mapping(old_map), Value::Mapping(new_map)) => {
            ...
            for (key, old_val) in old_map {
                ...
                match new_map.get(key) {
                    Some(new_val) => {
                        if old_val != new_val {
                            diff_values(old_val, new_val, new_path, changes);
                        }
                    }
                    None => {
                        changes.push(ConfigChange {
                            path: new_path,
                            old_value: Some(yaml_value_to_string_preview(old_val)),
                            new_value: None,
            ...
            for (key, new_val) in new_map {
                ...
                if !old_map.contains_key(key) {
                    ...
                    changes.push(ConfigChange {
                        path: new_path,
                        old_value: None,
                        new_value: Some(yaml_value_to_string_preview(new_val)),
        ...
        (Value::Sequence(old_seq), Value::Sequence(new_seq)) => {
            if old_seq != new_seq {
                changes.push(ConfigChange {
                    path,
                    old_value: Some(format!("{:?}", old_seq)),
                    new_value: Some(format!("{:?}", new_seq)),
...
/// Convert a YAML Value key to a string representation.
...
/// Convert a YAML Value to a short preview string.
fn yaml_value_to_string_preview(val: &Value) -> String {
    match val {
        Value::String(s) => {
            if s.len() > 80 {
                format!("{}...", &s[..77])
...
impl CliConfig {
    ...
    pub fn to_app_config(&self) -> hermes_core::config::AppConfig {
        let mut app = hermes_core::config::AppConfig::default();
        ...
        if let Some(skills_dir) = &self.hermes.skills_dir {
...
mod tests {
    ...
    fn test_default_config_has_all_sections() {
        ...
        assert_eq!(config.hermes.name.as_deref(), Some("hermes-rs"));
    ...
    fn test_default_config_version_is_set() {
        let config = CliConfig::default();
        assert_eq!(config.config_version.as_deref(), Some(CONFIG_VERSION));
    }
    ...
    #[test]
    fn test_migrate_0_1_0_to_0_2_0_renames_openai() {
        ...
        .unwrap();
        migrate_config(&mut config, "0.1.0", "0.2.0").unwrap();
        assert!(config.get("openai").is_none());
    ...
    #[test]
    fn test_migrate_0_3_0_to_0_4_0_renames_bots() {
        let mut config: Value = serde_yaml::from_str(
            r#"
        ...
        .unwrap();
        migrate_config(&mut config, "0.3.0", "0.4.0").unwrap();
        assert!(config.get("bots").is_none());
        assert!(config.get("integrations").is_some());
    }

    #[test]
    fn test_migrate_unknown_step_returns_error() {
        let mut config: Value = serde_yaml::from_str("config_version: '9.9.9'").unwrap();
        let result = migrate_config(&mut config, "9.9.9", "9.10.0");
        assert!(result.is_err());
    }

    #[test]
    fn test_migration_updates_version_field() {
        let mut config: Value = serde_yaml::from_str(
            r#"
            config_version: "0.1.0"
            "#,
        ...
        .unwrap();
        migrate_config(&mut config, "0.1.0", "0.2.0").unwrap();
        assert_eq!(config["config_version"].as_str(), Some("0.2.0"),);
    }
    ...
    #[test]
    fn test_validate_no_model_warning() {
        let config = CliConfig::default();
        let warnings = config.validate();
        // Default has no model — should warn
        let model_warnings: Vec<_> = warnings
            .iter()
            .filter(|w| w.field.as_deref() == Some("api.default_model"))
            .collect();
        assert!(
            !model_warnings.is_empty(),
            "Should warn when no default model is set"
        );
    }
    ...
    fn test_validate_bad_log_level() {
        ...
        config.logging.level = Some("BOGUS".to_string());
        let warnings = config.validate();
        let log_warnings: Vec<_> = warnings
            .iter()
            .filter(|w| w.field.as_deref() == Some("logging.level"))
            .collect();
        assert!(!log_warnings.is_empty());
    }

    #[test]
    fn test_validate_telegram_enabled_no_token() {
        let mut config = CliConfig::default();
        config.gateways.telegram.enabled = Some(true);
        config.gateways.telegram.token = None;
        let warnings = config.validate();
        let tel_warnings: Vec<_> = warnings
            .iter()
            .filter(|w| w.field.as_deref() == Some("gateways.telegram.token"))
            .collect();
        assert!(!tel_warnings.is_empty());
    }

    #[test]
    fn test_validate_compression_threshold() {
        let mut config = CliConfig::default();
        config.compression.threshold = Some(1.5);
        let warnings = config.validate();
        let comp_warnings: Vec<_> = warnings
            .iter()
            .filter(|w| w.field.as_deref() == Some("compression.threshold"))
            .collect();
        assert!(!comp_warnings.is_empty());
    }
    ...
    #[test]
    fn test_config_diff_identical_no_changes() {
        let config = CliConfig::default();
        let changes = config_diff(&config, &config);
        // Paths might differ (config_dir resolved differently), but at
        // minimum the struct fields should be similar
        assert!(changes.is_empty() || changes.iter().all(|c| c.path.starts_with("config_")));
    }

    #[test]
    fn test_config_diff_modified_value() {
        let mut old = CliConfig::default();
        old.api.default_model = Some("gpt-4".to_string());

        let mut new = CliConfig::default();
        new.api.default_model = Some("gpt-5".to_string());

        let changes = config_diff(&old, &new);
        let model_changes: Vec<_> = changes
            .iter()
            .filter(|c| c.path == "api.default_model")
            .collect();
        assert!(!model_changes.is_empty());
        assert_eq!(model_changes[0].change_type, ChangeType::Modified);
    }

    #[test]
    fn test_config_diff_added_field() {
        let old = CliConfig::default();
        let mut new = CliConfig::default();
        new.hermes.name = Some("custom-name".to_string());

        let changes = config_diff(&old, &new);
        let name_changes: Vec<_> = changes.iter().filter(|c| c.path == "hermes.name").collect();
    ...
    fn test_load_dotenv_file() {
        let _guard = env_lock().lock().unwrap();
        let dir = std::env::temp_dir().join(format!("hermes_dotenv_test_{}", std::process::id()));
    ...
    fn test_dotenv_quoted_values() {
        let _guard = env_lock().lock().unwrap();
        let dir = std::env::temp_dir().join(format!("hermes_dotenv_quote_{}", std::process::id()));
        let _ = std::fs::create_dir_all(&dir);
    ...
    #[test]
    fn test_hermes_env_overrides_model() {
        let _guard = env_lock().lock().unwrap();
    ...
    #[test]
    fn test_hermes_env_overrides_log_level() {
        let _guard = env_lock().lock().unwrap();
    ...
    // ================================================================
    // Known Env Vars Tests
    // ================================================================

    #[test]
    fn test_known_env_vars_has_required_entries() {
        let vars = known_env_vars();
        let names: Vec<&str> = vars.iter().map(|v| v.name).collect();

        assert!(names.contains(&"OPENAI_API_KEY"));
        assert!(names.contains(&"HERMES_HOME"));
        assert!(names.contains(&"HERMES_MODEL"));
        assert!(names.contains(&"TELEGRAM_BOT_TOKEN"));
        assert!(names.contains(&"TAVILY_API_KEY"));
        assert!(names.contains(&"FIRECRAWL_API_KEY"));
    }

    #[test]
    fn test_known_env_vars_all_have_descriptions() {
        let vars = known_env_vars();
        for v in &vars {
            assert!(
                !v.description.is_empty(),
                "Env var {} has no description",
                v.name
            );
        }
    }
