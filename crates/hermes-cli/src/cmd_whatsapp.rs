...
async fn whatsapp_status(_config: &AppConfig) -> Result<()> {
    ...
    if configured {
        ...
        println!("The interactive QR pairing wizard is available in the Python hermes-agent only.");
        println!("  Install with: pip install -e '.[whatsapp]' in hermes-agent/");
    } else {
        println!("WhatsApp is not configured. Run `hermes whatsapp setup` for instructions.");
    }
...
async fn whatsapp_setup(_config: &AppConfig) -> Result<()> {
    ...
    println!("Full WhatsApp integration requires the Python hermes-agent.");
    println!();
    println!("Step-by-step:");
    println!();
    println!("  1. Install the Python hermes-agent with WhatsApp support:");
    println!();
    println!("     cd hermes-agent/");
    ...
    println!();
    println!("  3. Run the Python hermes-agent with WhatsApp gateway:");
    println!();
    println!("     hermes gateway whatsapp");
    println!();
    ...
    println!("  - Sessions persist across restarts in the .hermes/ directory.");
    println!();
    println!("For more details, see the hermes-agent documentation.");
