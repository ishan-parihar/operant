...
//! - `hermes plugins install <identifier>` — install a plugin from git URL or path
//! - `hermes plugins remove <name>` — remove/uninstall a plugin
...
/// Resolve the plugins directory: `{data_dir}/hermes/plugins`
