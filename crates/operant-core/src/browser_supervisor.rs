//! Cloud browser automation supervisor for Operant-RS.
//!
...
//!
//! ```ignore
//! use operant_core::browser_supervisor::{
...
#[async_trait]
impl OperantTool for BrowserSupervisorTool {
    fn name(&self) -> &str {
        "browser_supervisor"
    }
...
#[async_trait]
impl OperantTool for CdpNavigateTool {
    fn name(&self) -> &str {
        "cdp_navigate"
    }
...
#[async_trait]
impl OperantTool for DialogBridgeTool {
    fn name(&self) -> &str {
        "dialog_bridge"
    }
    ...
    async fn execute(&self, args: Value, _context: ToolContext) -> ToolResult {
        ...
        let js = parsed
            .js_expression
            .unwrap_or_else(|| "window.__operantDialogBridge = true;".to_string());
...
mod tests {
    ...
    async fn test_inject_dialog_bridge() {
        ...
        let msg = supervisor
            .inject_dialog_bridge(&session.session_id, "window.__operant = true;")
            .await
            .unwrap();
