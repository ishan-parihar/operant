...
#[async_trait]
impl OperantTool for SpotifyPlaybackTool {
    fn name(&self) -> &str {
        "spotify_playback"
    }
...
#[async_trait]
impl OperantTool for SpotifyDevicesTool {
    fn name(&self) -> &str {
        "spotify_devices"
    }
    fn description(&self) -> &str {
...
#[async_trait]
impl OperantTool for SpotifyQueueTool {
    fn name(&self) -> &str {
        "spotify_queue"
    }
    fn description(&self) -> &str {
...
#[async_trait]
impl OperantTool for SpotifySearchTool {
    fn name(&self) -> &str {
        "spotify_search"
    }
    fn description(&self) -> &str {
...
#[async_trait]
impl OperantTool for SpotifyPlaylistsTool {
    fn name(&self) -> &str {
        "spotify_playlists"
    }
    fn description(&self) -> &str {
...
#[async_trait]
impl OperantTool for SpotifyAlbumsTool {
    fn name(&self) -> &str {
        "spotify_albums"
    }
    fn description(&self) -> &str {
...
#[async_trait]
impl OperantTool for SpotifyLibraryTool {
    fn name(&self) -> &str {
        "spotify_library"
    }
    fn description(&self) -> &str {
