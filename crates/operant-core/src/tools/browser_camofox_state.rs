...
//! State files are stored in ~/.operant/camofox_states/ as JSON files.
...
fn state_dir() -> PathBuf {
    ...
    home.join(".operant").join("camofox_states")
}
...
#[async_trait]
impl OperantTool for CamofoxStateTool {
    fn name(&self) -> &str {
    ...
    fn description(&self) -> &str {
        "Manage persistent browser state for the Camofox browser tool. \
         ...
         State files are stored in ~/.operant/camofox_states/."
    }
