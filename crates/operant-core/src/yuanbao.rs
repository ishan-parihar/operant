...
#[async_trait]
impl OperantTool for YuanbaoQueryGroupInfo {
    fn name(&self) -> &str {
        "yb_query_group_info"
    }
...
#[async_trait]
impl OperantTool for YuanbaoQueryGroupMembers {
    fn name(&self) -> &str {
...
#[async_trait]
impl OperantTool for YuanbaoSendDm {
    fn name(&self) -> &str {
        "yb_send_dm"
    }
...
#[async_trait]
impl OperantTool for YuanbaoSearchSticker {
    fn name(&self) -> &str {
        "yb_search_sticker"
    }
...
#[async_trait]
impl OperantTool for YuanbaoSendSticker {
    fn name(&self) -> &str {
        "yb_send_sticker"
    }
