...
//
// When enabled, Operant can execute actions on Gmail, Notion, GitHub, Slack, etc.
...
impl ComposioTool {
    ...
    fn client(&self) -> Client {
        operant_config::schema::build_runtime_proxy_client_with_timeouts("tool.composio", 60, 10)
    }
