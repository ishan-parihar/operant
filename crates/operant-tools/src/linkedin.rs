...
use operant_config::schema::{LinkedInContentConfig, LinkedInImageConfig};
use serde_json::json;
...
mod tests {
    ...
    async fn get_content_strategy_returns_config() {
        let content = LinkedInContentConfig {
            ...
            github_repos: vec!["operant-labs/operant".into()],
        ...
        assert!(result.output.contains("operant-labs/operant"));
