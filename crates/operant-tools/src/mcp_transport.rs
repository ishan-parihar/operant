...
use operant_config::schema::{McpServerConfig, McpTransport};
...
impl SseTransport {
    ...
    #[expect(dead_code, reason = "WIP: alternate message URL fallback")] // WIP: alternate message URL fallback
...
mod tests {
    ...
    fn create_transport_stdio_fails_without_valid_command() {
        ...
        let config = McpServerConfig {
            ...
            command: "/usr/bin/operant_nonexistent_binary_abc123".into(),
            ..Default::default()
        };
