...
use operant_config::schema::FirecrawlConfig;
use serde_json::json;
use std::sync::Arc;
...
mod tests {
    ...
    fn firecrawl_config_defaults() {
        ...
        assert_eq!(cfg.mode, operant_config::schema::FirecrawlMode::Scrape);
    }
    ...
    fn firecrawl_config_deserializes_from_toml() {
        ...
        assert_eq!(cfg.mode, operant_config::schema::FirecrawlMode::Crawl);
    }
    ...
    fn web_fetch_config_with_firecrawl_section() {
        use operant_config::schema::WebFetchConfig;
        let toml_str = r#"
            enabled = true
            [firecrawl]
            enabled = true
