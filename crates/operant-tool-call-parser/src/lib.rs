...
/// <FunctionCall>
/// file_read
/// <code>path>/Users/kylelampa/Documents/operant/README.md</code>
/// </FunctionCall>
/// ```
...
/// Map tool name aliases from various LLM providers to Operant tool names.
...
/// to. This function encodes the mapping for known Operant tools.
...
pub fn parse_tool_calls(response: &str) -> (String, Vec<ParsedToolCall>) {
    ...
    // 2. Operant tool-call tags (<tool_call>, <toolcall>, <tool-call>)
...
Let me check the result."#;
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // Additional parser internals tests (moved from operant-runtime to keep
