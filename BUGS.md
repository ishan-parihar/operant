...
- **Tests**: 5 new unit tests (cloud-metadata IP, loopback, metadata hostname for `http_request`; metadata IP + RFC 1918 for `web_fetch`) — all pass. Full `operant-core` lib: 1191 passed; `operant-cli`: 631 passed.
