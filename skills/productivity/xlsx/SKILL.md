...
For full investment-banking conventions (balance checks, sensitivity tables, named ranges), install the optional skill: `operant skills market install excel-author`.
