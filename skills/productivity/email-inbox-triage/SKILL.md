...
metadata:
  operant:
    ...
    related_skills: [email, google-auth]
---

# Email Inbox Triage

Turn a mailbox into a bounded queue of decisions. This skill owns thread-aware prioritization and reply policy; connector skills (`email`, `calendar`) own provider commands.
